...
class UserAuthenticationSystem {
  private _sessionValidator: ValidateReqAppendUser = container.get<ValidateReqAppendUser>(
    TYPES.UserSessionValidator,
  );
...
const promiseFns = {
  isUserAuthenticated: (req: Request, res: Response, next: NextFunction) =>
    authSystem.isUserAuthenticated(req, res, next),
  isUserApproved: (req: Request, res: Response, next: NextFunction) =>
    authSystem.isUserApproved(req, res, next),
  isUserAdmin: (req: Request, res: Response, next: NextFunction) =>
    authSystem.isUserAdmin(req, res, next),
};
